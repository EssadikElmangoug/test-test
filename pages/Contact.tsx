...
import { INSTAGRAM_URL, FACEBOOK_URL, YOUTUBE_URL, INSTAGRAM_ICON, FACEBOOK_ICON, YOUTUBE_ICON } from '../constants';
  ...
  return (
    <div className="bg-black text-white min-h-screen py-20 px-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 relative z-10">
        <div>
          <h1 className="text-7xl md:text-9xl font-black tracking-tighter text-cyan-400 mb-8 italic uppercase leading-none">
            TALK <span className="text-pink-500">SH*T</span>
          </h1>
          <p className="text-2xl font-bold mb-12 leading-relaxed uppercase">
            Need a high-energy show? Want to send us hate mail? Or just want to tell us your favorite Blink song? 
            Don't be a dick, get in touch today!
          </p>
        ...
        <div className="relative">
          {/* Decorative elements to give it that "taped on" look */}
          ...
          <div className="bg-white text-black p-8 md:p-12 border-4 border-black relative overflow-hidden">
            ...
            {submitted ? (
              <div className="text-center py-20 flex flex-col items-center">
                <div className="punk-font text-7xl mb-6 animate-bounce text-pink-500">F**K YEAH!</div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="group">
                  ...
                  <input 
                    ...
                    type="text" 
                    required
                    className="w-full p-4 border-4 border-black font-bold focus:ring-8 focus:ring-pink-500/20 outline-none placeholder:text-gray-400 bg-white text-black"
                    placeholder="NAME / VENUE / LABEL"
                  />
                </div>

                <div className="group">
                  <label className="block font-black text-lg mb-2 uppercase group-focus-within:text-cyan-600 transition-colors text-black">WHERE DO WE SEND THE REPLY?</label>
                  <input 
                    name="email"
                    type="email" 
                    required
                    className="w-full p-4 border-4 border-black font-bold focus:ring-8 focus:ring-cyan-500/20 outline-none placeholder:text-gray-400 bg-white text-black"
                ...
                <div className="group">
                  ...
                  <textarea 
                    ...
                    rows={4}
                    required
                    className="w-full p-4 border-4 border-black font-bold focus:ring-8 focus:ring-yellow-500/20 outline-none placeholder:text-gray-400 bg-white text-black"
                ...
                <button 
                  type="submit"
                  className="w-full bg-black text-white py-6 font-black text-3xl flex items-center justify-center gap-4 hover:bg-pink-500 hover:scale-105 transition-all active:scale-95 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-none"
                >
                  SEND IT! <Send size={32} />
                </button>
                
                <p className="text-xs font-bold text-gray-500 mt-4 text-center uppercase">
                  By clicking send, you agree that Mark Hoppus is a legend.
                </p>
              </form>
            )}
          </div>
